...
public class SectionsPageAdapter extends FragmentStatePagerAdapter {
    ...
    public static class TitleStringUtils {
        ...
        public String[] gettitlesAsRoleIsAdmin() {
            return new String[]{mContext.getResources().getString(R.string.tab_title_information), mContext.getString(R.string.tab_title_member), mContext.getResources().getString(R.string.tab_title_chat), mContext.getResources().getString(R.string.tab_title_request)};
        }

        public String[] gettitlesAsRoleIsNormal() {
            return new String[]{mContext.getResources().getString(R.string.tab_title_information), mContext.getString(R.string.tab_title_member), mContext.getResources().getString(R.string.tab_title_chat)};
        }
    }
}
